...
const GALLERY_IMAGES = [
  { src: "/images/volleyball.webp", caption: "Professional Volleyball Arena", category: "Arena" },
  { src: "/images/gallery-volley-1-optimized.webp", caption: "Volleyball Training Session", category: "Arena" },
  { src: "/images/gallery-volley-2-optimized.webp", caption: "Volleyball Net Setup", category: "Arena" },
  { src: "/images/gallery-volley-3.webp", caption: "Volleyball Court View", category: "Arena" },
  { src: "/images/gallery-volley-4-optimized.webp", caption: "Volleyball Spiking Practice", category: "Arena" },
  { src: "/images/gallery-volley-5-optimized.webp", caption: "Volleyball Serve Setup", category: "Arena" },
  { src: "/images/pickleball.webp", caption: "Elite Pickleball Courts", category: "Racket Sports" },
  { src: "/images/gallery-pickle-1.webp", caption: "Pickleball Academy", category: "Racket Sports" },
  { src: "/images/cricket-card.webp", caption: "Premium Cricket Nets", category: "Cricket" },
  { src: "/images/table-tennis.webp", caption: "Table Tennis Championship Hall", category: "Indoor Sports" },
  { src: "/images/gallery-tabletennis-1.webp", caption: "Table Tennis Tables", category: "Indoor Sports" },
  { src: "/images/gallery-tabletennis-2.webp", caption: "Table Tennis Racket & Ball", category: "Indoor Sports" },
  { src: "/images/gallery-tabletennis-3.webp", caption: "Table Tennis Practice", category: "Indoor Sports" },
  { src: "/images/gallery-tabletennis-4.webp", caption: "Table Tennis Match View", category: "Indoor Sports" },
  { src: "/images/chess.webp", caption: "Strategic Chess Academy", category: "Indoor Sports" },
  { src: "/images/gallery-chess-1.webp", caption: "Chess Board Setup", category: "Indoor Sports" },
  { src: "/images/foosball.webp", caption: "Foosball & Gaming Lounge", category: "Recreation" },
  { src: "/images/gallery-foosball-1.webp", caption: "Foosball Table Detail", category: "Recreation" },
  { src: "/images/gallery-foosball-2.webp", caption: "Foosball Action Shot", category: "Recreation" },
  { src: "/images/gallery-foosball-3.webp", caption: "Foosball Players", category: "Recreation" },
  { src: "/images/gallery-foosball-4.webp", caption: "Foosball Setup", category: "Recreation" },
  { src: "/images/gallery-foosball-5.webp", caption: "Foosball Match", category: "Recreation" },
  { src: "/images/carroms.webp", caption: "Carrom Training Center", category: "Indoor Sports" },
  ...
  { src: "/images/air-hockey.webp", caption: "Arcade Zone - Air Hockey", category: "Recreation" },
  { src: "/images/gallery-airhockey-1.webp", caption: "Air Hockey Puck & Striker", category: "Recreation" },
  ...
  { src: "/images/DLP03631-optimized.webp", caption: "Bridge Course Visit 2", category: "Events" },
  { src: "/images/DLP03633-optimized.webp", caption: "Bridge Course Visit 3", category: "Events" },
...
const GalleryImageItem = ({ image, onOpenLightbox }: { image: any, onOpenLightbox: () => void }) => {
  ...
  const isVideo = image.type === 'video' || src.toLowerCase().endsWith('.webm');
    ...
    <div className="pt-20 min-h-screen bg-[var(--bg-primary)]">
      ...
      {lightbox !== null && (
        <div className="fixed inset-0 z-[100] bg-[var(--bg-primary)]/95 backdrop-blur-sm flex items-center justify-center p-6" onClick={() => setLightbox(null)}>
          ...
          {GALLERY_IMAGES[lightbox].type === 'video' || GALLERY_IMAGES[lightbox].src.toLowerCase().endsWith('.webm') ? (
            <video
