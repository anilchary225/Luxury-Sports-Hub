...
const SPORTS = [
  ...
  },
  {
    ...
    description: "Table Tennis at Zenithh Sports Arena is coached to a high competitive standard. Our professional tables, certified coaches, and structured training methodology develop players who can compete from club level all the way to collegiate and state competitions. Players searching for Table Tennis Court Near Me Miyapur can train and play at Zenithh with quality facilities. Our Table Tennis Court Near Me Miyapur experience is suitable for casual players and competitive athletes.",
    features: [
  ...
  },
  {
    ...
    description: "Foosball (table football) at Zenithh Sports Arena goes beyond casual recreation. We coach the technical skills, strategic thinking, and reflexive control that competitive foosball demands — making it a serious sport within our multi-sport facility. If you are searching for Foosball Near Me Miyapur, Zenithh offers an exciting indoor gaming experience. Our Foosball Near Me Miyapur sessions are ideal for friends, groups, and competitive fun.",
    features: [
...
export default function SportsPage() {
  ...
  const currentSEO = sportSlug ? SEO_METADATA[sportSlug] : undefined;
    ...
    <>
      {currentSEO && (
        <SEO
          ...
          canonical={`https://www.zenithh.com/sports/${sportSlug}`}
        />
      )}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 max-w-[1400px] mx-auto">
            {SPORTS.map((sport, i) => (
              ...
              >
                ...
                >
                  <img loading="lazy" src={sport.img} alt={sport.title} className="w-full h-full object-cover" onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = '/images/about-arena.webp'; }} />
