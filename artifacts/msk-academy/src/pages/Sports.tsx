...
const SPORTS = [
  {
    ...
    programs: [
      {
        name: "Beginner",
        desc: "Grip, stance, footwork, batting posture, basic bowling action, and fielding fundamentals. Every session builds confidence and a love for the game.",
      },
      {
        name: "Intermediate",
        desc: "Batting shot selection, bowling variations (pace, swing, spin), fielding agility, structured drill sessions, practice matches, and sports psychology.",
      },
      {
        name: "Advanced",
        desc: "High-intensity conditioning, position-specific mastery, video analysis, opposition strategy reading, and intensive match simulation at professional academy standards.",
      },
    ],
  },

  {
    ...
    programs: [
      {
        name: "Beginner",
        desc: "Court dimensions, basic strokes (forehand, backhand, serve), and scoring system. Sessions make learning fun and build a solid technical foundation from day one.",
      },
      {
        name: "Intermediate",
        desc: "Stroke consistency, the 'third shot drop,' mastering the kitchen (non-volley zone), improved footwork, and strategic shot placements with accuracy.",
      },
      {
        name: "Advanced Competitive",
        desc: "Aggressive net play, speed-up drills, erne shots, ATP (around-the-post) techniques, full match simulations, and performance analysis.",
      },
    ],
  },

  {
    ...
    programs: [
      {
        name: "Foundation",
        desc: "Court orientation, forearm passing (bump), serve technique, and introductory setting. Builds genuine technical confidence before advancing.",
      },
      {
        name: "Intermediate",
        desc: "Powerful spike approaches, back-row attack techniques, jump serving, libero defensive skills, positional rotations, and reading opponent attacks.",
      },
      {
        name: "Advanced Competitive",
        desc: "Elite-level conditioning, position-mastery drills, video analysis, match simulation, and mental performance training for district and state competitions.",
      },
    ],
  },

  {
    ...
    programs: [
      {
        name: "Beginner",
        desc: "Piece movements, basic rules, checkmate patterns, and fundamental openings. Builds logical thinking and introduces the joy of strategic play.",
      },
      {
        name: "Intermediate",
        desc: "Opening theory, tactical motifs (pins, forks, skewers), positional understanding, and structured game analysis to build competitive awareness.",
      },
      {
        name: "Advanced Tournament",
        desc: "Deep opening preparation, complex endgame technique, psychological approach to competitions, and full game analysis for serious competitive chess.",
      },
    ],
  },

  {
    ...
    programs: [
      {
        name: "Foundation Zumba",
        desc: "Basic rhythms, simple choreography, and fundamental footwork for complete beginners. Focus on enjoyment, coordination, and building aerobic stamina.",
      },
      {
        name: "Intermediate",
        desc: "More complex choreography sequences, faster rhythm combinations, body conditioning elements, and increased cardiovascular intensity.",
      },
      {
        name: "Zumba Toning",
        desc: "Incorporates light weights and toning sticks alongside dance to simultaneously build muscular endurance and cardiovascular fitness.",
      },
    ],
  },

  {
    ...
    description:
      "Table Tennis at Zenithh Sports Arena is coached to a high competitive standard. Our professional tables, certified coaches, and structured training methodology develop players who can compete from club level all the way to collegiate and state competitions. Players searching for Table Tennis Court Near Me Miyapur can train and play at Zenithh with quality facilities. Our Table Tennis Court Near Me Miyapur experience is suitable for casual players and competitive athletes.",
    features: [
    ...
    programs: [
      {
        name: "Beginner",
        desc: "Table rules, grip technique, forehand drive, backhand push, and basic serve. Builds consistent ball control and the fundamentals of rally play.",
      },
      {
        name: "Intermediate",
        desc: "Topspin techniques, loop shots, sidespin serves, footwork patterns, and structured point-play training to develop match competence.",
      },
      {
        name: "Advanced",
        desc: "High-speed rally training, advanced serve-and-attack combinations, deceptive spin play, and full competitive match simulation with video analysis.",
      },
    ],
  },

  {
    ...
    programs: [
      {
        name: "Beginner",
        desc: "Basic rod control, shooting mechanics, goalie technique, and fundamental offensive and defensive positioning for new players.",
      },
      {
        name: "Intermediate",
        desc: "Advanced ball control (snake shot, pull shot), defensive walls, counter-attack strategies, and 2-player team coordination for doubles play.",
      },
      {
        name: "Competitive",
        desc: "Match-speed drills, shot accuracy under pressure, tournament tactics, and mental composure training for competitive foosball environments.",
      },
    ],
  },

  {
    ...
    programs: [
      {
        name: "Beginner",
        desc: "Proper striker grip, basic striking technique, coin positioning, and fundamental board sense. Introduces the joy and depth of carrom to new players.",
      },
      {
        name: "Intermediate",
        desc: "Advanced angle play, cover disc techniques, defensive carrom positioning, and structured match play for competitive development.",
      },
      {
        name: "Advanced",
        desc: "Precision shot mastery, cut shots, thumb shots, board reading under competitive pressure, and full tournament simulation.",
      },
    ],
  },
    ...
    programs: [
      {
        ...
        desc: "Open-play sessions for individuals and groups. Perfect for campus recreation, stress relief, and building competitive spirit in a fun environment.",
      },
      {
        name: "Competitive Training",
        desc: "Focused reflex drills, mallet control technique, defensive wall strategies, and shot placement accuracy for competitive air hockey play.",
      },
    ],
  },

  {
    ...
    programs: [
      {
        name: "VR Basic Experience",
        desc: "Introduction to VR technology, basic stance adjustment, and facing medium-pace deliveries in a virtual environment.",
      },
      {
        name: "Pro Match Simulation",
        desc: "Face specific bowling styles (left-arm pace, leg-spin, off-spin) and practice reading the bowler's hand and release points.",
      },
    ],
  },

  {
    ...
    programs: [
      {
        name: "Recreational Play",
        desc: "Court bookings for friends and families looking to enjoy casual games in an energetic outdoor setting.",
      },
      {
        name: "Foundational Coaching",
        desc: "Focuses on grip, footwork, basic clears, drops, and serves to build a strong badminton foundation.",
      },
    ],
  },
];
...
export default function SportsPage() {
  ...
  const sportSlug = currentPath.startsWith("/sports/")
    ...
    const resolvedSportId = sportSlug
    ? Object.keys(SPORT_SLUGS).find(
        (id) => SPORT_SLUGS[id] === sportSlug
      ) || sportSlug
    : undefined;
      ...
      <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] selection:bg-primary selection:text-[var(--text-inverse)]">
        ...
        <section className="relative min-h-[90vh] flex items-center justify-center pt-24 pb-12 overflow-hidden bg-grain">
          ...
          <div className="container mx-auto px-6 relative z-10 text-center">
            ...
            >
              11 Disciplines · Professional Coaching ·
              World-Class Infrastructure. Explore our
              high-performance training programs in Hyderabad.
            </motion.p>
          </div>
        </section>
        ...
        <section className="py-32 bg-[var(--bg-primary)] relative border-y border-[var(--border-light)]">
          <div className="container mx-auto px-6">
            ...
            >
              <motion.h2
                variants={fadeIn}
                className="text-3xl md:text-5xl font-black uppercase mb-6 text-[var(--text-primary)]"
              >
                SELECT YOUR{" "}
                <span className="text-primary italic">
                  ARENA
              ...
              <motion.p
                variants={fadeIn}
                className="text-muted max-w-2xl mx-auto text-lg font-light leading-relaxed"
              >
                Discover our comprehensive range of
                programs, each designed to push athletic
                boundaries and build championship character.
              </motion.p>
            </motion.div>
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute inset-0 p-6 flex flex-col justify-end">
                      <h3 className="text-[var(--text-primary)] font-black uppercase text-xs md:text-sm tracking-[0.2em] group-hover:text-primary transition-colors leading-tight">
                        {sport.title}
                      </h3>
                    </div>
                  </Link>
              ...
              >
                ...
                >
                  ...
                  <div className="space-y-6">
                    <h4 className="text-[10px] font-bold uppercase tracking-[0.4em] text-muted mb-6">
                      Structured Programs
                    </h4>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      ...
                      {sport.programs.map(
                        (prog, pi) => (
                          <div
                            key={pi}
                            className="p-5 sm:p-6 bg-[var(--bg-secondary)] border border-[var(--border-light)] hover:border-primary/20 transition-all duration-300"
                          >
                            <div className="flex items-center gap-3 mb-3">
                              <span className="w-1.5 h-1.5 bg-primary rotate-45 flex-shrink-0" />

                              <h5 className="font-black text-xs text-[var(--text-primary)] uppercase tracking-widest">
                                {prog.name}
                              </h5>
                            </div>
                ...
                <div className="flex-1">
                  ...
                  <motion.span
                    variants={fadeIn}
                    className="text-primary font-bold tracking-[0.5em] uppercase text-[10px] block mb-6"
                  >
                    DISCIPLINE OVERVIEW
                  </motion.span>
                  ...
                  <motion.h2
                    variants={fadeIn}
                    className="text-3xl md:text-5xl font-black uppercase mb-4 lg:mb-8 text-[var(--text-primary)] leading-tight"
                  >
                    {sport.tagline}
                  </motion.h2>
                  ...
                  <motion.p
                    variants={fadeIn}
                    className="text-muted text-lg leading-relaxed mb-6 lg:mb-12 font-light"
                  >
                    {renderKeyword(
                      sport.description,
                      sport.seoKeyword
                  ...
                  >
                    <h4 className="text-[10px] font-bold uppercase tracking-[0.4em] text-muted mb-4 lg:mb-8">
                      ...
                      {sport.features.map(
                        (feat, fi) => (
                          ...
                          >
                            ...
                            <span className="text-[var(--text-muted)] text-sm font-medium group-hover:text-[var(--text-primary)] transition-colors">
                              {feat}
                            </span>
                          </div>
                        )
                  ...
                  <motion.div
                    variants={fadeIn}
                    className="mt-8 lg:mt-16 flex flex-col sm:flex-row gap-4 sm:gap-6"
                  >
                    <Link
                      to={`/sports/${SPORT_SLUGS[sport.id]}`}
